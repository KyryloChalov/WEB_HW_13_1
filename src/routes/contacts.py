...
# @router.get("/birthdays_1/", response_model=List[ContactResponse])
...
# @router.get("/birthdays_2/", response_model=List[ContactResponse])
...
# @router.get("/birthdays_4/", response_model=List[ContactResponse])
